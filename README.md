...
- workflow_dispatch = Manually Trigger Workflows from GHA
  ...
  - build-farmos-release = Builds a custom 4.0.1 image for production
...
- tags = Tag a release of farmos-mountain-site
  - deploy-farmos-release-live = Builds & deploys a custom 4.0.1 image for production
...
- workflow_dispatch = Manually Trigger Workflows from GHA
  ...
  - redeploy-farmos-release-live = Redeploys a custom 4.0.1 image (without rebuild) for production
